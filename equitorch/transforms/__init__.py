...
class RadiusGraph(BaseTransform):
    ...
    within a given distance (functional name: :obj:`radius_graph_et`).
    ...
    Args:
        ...
        edge_vector_attr (str): The attribute name for creating edge vectors 
            in the data. (default: :obj:`edge_attr`),
    ...
    def __init__(
        ...
        edge_vector_attr: str = 'edge_attr',
        num_workers: int = 1,
    ) -> None:
        self.r = r
        self.loop = loop
    ...
    def forward(self, data: Data) -> Data:
        ...
        data.__setattr__(self.edge_vector_attr, 
            data.pos[data.edge_index_pos[1]] - data.pos[data.edge_index_pos[0]]
        )
...
class AddEdgeSphericalHarmonics(BaseTransform):
    ...
    Args:
        ...
        edge_vector_attr (str): The attribute name for 
            edge direction vectors. (default: :obj:`edge_attr`)
...
class AddEdgeAlignWignerD(BaseTransform):
    ...
    def forward(self, data: Data) -> Data:
        ...
        edge_vec = data.__getattr__(self.edge_vector_attr)
        data.__setattr__(self.align_wigner_attr, align_to_z_wigner(edge_vec))
